            ...
            <section className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
              ...
              <form className="space-y-6">
                ...
                <div className="flex justify-end pt-4 border-t border-slate-100">
                  <button 
                    type="button" 
                    className="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-8 rounded-xl shadow-lg shadow-green-100 transition-transform active:scale-95 flex items-center gap-2"
                  >
                    <Save size={18} />
                    Salvar alterações
                  </button>
