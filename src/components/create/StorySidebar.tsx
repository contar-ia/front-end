...
export function StorySidebar({ theme, ageGroup }: StorySidebarProps) {
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li className="flex items-center gap-3">
              <div className="p-2 bg-white rounded-full text-red-400 shadow-sm"><Shield size={16} /></div>
              <span className="text-slate-700 font-medium">Um cavaleiro corajoso</span>
            </li>
            <li className="flex items-center gap-3">
              <div className="p-2 bg-white rounded-full text-red-400 shadow-sm"><User size={16} /></div>
              <span className="text-slate-700 font-medium">Um esquilo falante</span>
            </li>
          </ul>
        </div>
